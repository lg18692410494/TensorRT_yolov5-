...
static void test(SimpleYolo::Type type, SimpleYolo::Mode mode, const string& model){
    ...
    string onnx_file ="/home/long/home/project1/yolov5-master/yolov5n.onnx";
    string model_file = "/home/long/home/project1/cpp-simple-yolov5/workspace/yolov5n.engine";
...
{   int deviceid = 0;
    ...
    string onnx_file ="/home/long/home/project1/yolov5-master/yolov5n.onnx";
    string engine_file = "/home/long/home/project1/cpp-simple-yolov5/workspace/yolov5n.engine";
    int test_batch_size = 1;
    ...
    auto engine = SimpleYolo::create_infer(engine_file, SimpleYolo::Type::V5, deviceid, 0.4f, 0.5f);
    if(engine == nullptr){
        printf("Engine is nullptr\n");
        return;
    }

    string video_path="xr.mp4";
    ...
    {   auto begin_timer = timestamp_now_float();
        auto boxss=engine->commit(frame);
        auto boxes=boxss.get();
        for(auto& obj : boxes){
            uint8_t b, g, r;
            tie(b, g, r) = random_color(obj.class_label);
